                        ...
                        echo "<table class='table'>";
                          echo "<thead class='thead-dark'>";
                            echo "<tr class='thcenter'>";
                              echo "<th colspan='9'>ข้อมูลลูกค้า (ออนไลน์ - สรุป)</th>";
                            echo "</tr>";
                          echo "</thead>";
                        echo "</table>";
                        ?>
                            ...
                            <tbody>
                              ...
                              foreach($member as $data){
                                  echo "<tr>";
                                    ...
                                    echo "<td><a href=",base_url(),"sell/conclude_approve_detail/".$data['member_id']," style='margin-right:20px;' target='_blank' class='btn bg-light-blue waves-effect'>PRINT </a></td>";
