                    ...
                    if($type == '2'){
                      ...
                      echo "<li>";
                          echo "<a href='javascript:void(0);' class='menu-toggle'>";
                              ...
                              echo "<span>ข้อมูลรายรับรายจ่าย</span>";
                          echo "</a>";
                          echo "<ul class='ml-menu'>";
                              echo "<li>";
                                  echo "<a href=",base_url(),"Account>";
                                    echo "<span>ข้อมูลรายรับรายจ่าย</span>";
                                  echo "</a>";
                              echo "</li>";
                          echo "</ul>";
                      ...
                      echo "<li>";
                          echo "<a href='javascript:void(0);' class='menu-toggle'>";
                              ...
                              echo "<span>จัดการข้อมูลการสั่งซื้อ</span>";
                          echo "</a>";
                          echo "<ul class='ml-menu'>";
                              echo "<li>";
                                  echo "<a href=",base_url(),"Order>";
                                    echo "<span>ข้อมูลการสั่งซื้อ</span>";
                                  echo "</a>";
                              echo "</li>";
                              echo "<li>";
                                  echo "<a href=",base_url(),"Order_debtor>";
                                    echo "<span>ข้อมูลการส่งซื้อ (เชื่อ)</span>";
                                  echo "</a>";
                              echo "</li>";
                          echo "</ul>";
                      echo "</li>";
                      echo "<li>";
                          echo "<a href='javascript:void(0);' class='menu-toggle'>";
                              ...
                              echo "<span>จัดการข้อมูลลูกค้าการขาย</span>";
                          echo "</a>";
                          echo "<ul class='ml-menu'>";
                              echo "<li>";
                              ...
                              echo "</li>";
                              echo "<li>";
                                  echo "<a href=",base_url(),"sell/conclude_approve>";
                                    echo "<span>ข้อมูลลูกค้าขายสด (ออนไลน์ - สรุป)</span>";
                                  echo "</a>";
                              echo "</li>";
                              echo "<li>";
                              ...
                              echo "</li>";
                              echo "<li>";
                                  echo "<a href=",base_url(),"debtor/conclude_debtor>";
                                    echo "<span>ข้อมูลลูกค้าขายเชื่อ (สรุป)</span>";
                                  echo "</a>";
                              echo "</li>";
                          echo "</ul>";
                      echo "</li>";
                      ...
                      echo "<li>";
                          echo "<a href='javascript:void(0);' class='menu-toggle'>";
                              echo "<i class='material-icons'>pie_chart</i>";
                              echo "<span>จัดการข้อมูลผู้ขาย</span>";
                          echo "</a>";
                          echo "<ul class='ml-menu'>";
                              echo "<li>";
                                  echo "<a href=",base_url(),"partners>";
                                    echo "<span>ข้อมูลผู้ขาย</span>";
                                  echo "</a>";
                              echo "</li>";
                          echo "</ul>";
                      echo "</li>";
                      ...
                      /*echo "<li>";
                          ...
                          echo "<ul class='ml-menu'>";
                              ...
                              echo "</li>";
                              echo "<li>";
                                  echo "<a href=",base_url(),"sell/conclude_sell_debtor>";
