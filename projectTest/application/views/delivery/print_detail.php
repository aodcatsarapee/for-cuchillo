...
<div style="text-align: center;">
    ...
    <span style="font-size: 25px; font-weight: bold;">รายละเอียดการส่งสินค้า</span><br>
...
<span style="font-size: 20px; font-weight: bold;">ลูกค้าชื่อ : <?php echo $member['member_firstname']," ",$member['member_lastname']; ?> </span> <span
      ...
      foreach ($detail_name as $__detail_name) {
        if($_detail['sell_detail_date'] == $__detail_name['sell_detail_date']){
          echo "<tr>";
            ...
            echo "<td style='text-align:center;'>",$_detail['pay_status'],"</td>";
          echo "</tr>";
        }
      }
    echo "</tr>";
